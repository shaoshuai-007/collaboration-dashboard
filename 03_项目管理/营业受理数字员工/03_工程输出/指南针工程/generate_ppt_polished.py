...
def add_header(slide, title, subtitle=""):
    ...
    if subtitle:
        add_text(slide, 6.5, 0.45, 6, 0.4, f"——{subtitle}", 12, False, NEUTRAL)
...
add_text(slide, 6.5, 0.55, 6, 0.4, "——四大篇章清晰呈现", 12, False, NEUTRAL)
...
items = [
    ...
    ("解决方案设计", "建设营业受理数字员工，打造智能问答、智能查询、智能办理、智能诊断四大核心能力，全方位赋能一线营业员，提升效率改善体验。")
]
add_measure_content(slide, items)
...
add_text(slide, 0.8, 2.2, 4.5, 1.2, "采用分层架构设计理念，每层职责单一明确，便于独立开发、测试、运维，支持横向扩展。大模型+RAG技术成熟，开源组件丰富，技术风险可控。", 12, False, NEUTRAL_DARK)
...
# 保存
output_path = "/root/.openclaw/workspace/03_项目管理/营业受理数字员工/03_工程输出/指南针工程/营业受理数字员工建设方案_润色版.pptx"
prs.save(output_path)
print(f"\n✅ 润色版PPT已生成: {output_path}")
print(f"总页数: {len(prs.slides)}")
print("\n改进点：")
print("1. 每一页目标和举措润色，增加业务描述")
print("2. 标题侧增加冒号+一句话总结（不超过10个字）")
print("\n一句话总结示例：")
print("- 项目背景：满足考核解决痛点")
print("- 问题分析：定位根因精准施策")
print("- 建设目标：四大能力集群作战")
print("- 整体架构：六层分层清晰可落地")
print("- 智能问答：大模型加RAG技术")
print("- 智能查询：实体抽取API集成")
print("- 智能办理：多轮对话智能填单")
print("- 智能诊断：规则引擎云哨对接")
print("- 系统集成：API网关统一集成")
print("- 实施路径：五个月四阶段落地")
print("- 关键指标：效果可量化可追踪")
print("- 核心价值：四大价值全面释放")
print("- 创新亮点：五大创新引领行业")
