...
# 保存
output_path = "/root/.openclaw/workspace/03_项目管理/营业受理数字员工/03_工程输出/指南针工程/营业受理数字员工建设方案_终版.pptx"
prs.save(output_path)
print(f"\n✅ 终版PPT已生成: {output_path}")
print(f"总页数: {len(prs.slides)}")
print("\n改进点：")
print("1. 标题格式改为'标题：副标题'")
print("2. 副标题字体与标题一致（24pt加粗）")
print("\n标题示例：")
print("- 项目背景：满足考核解决痛点")
print("- 问题分析：定位根因精准施策")
print("- 建设目标：四大能力集群作战")
print("- 整体架构：六层分层清晰可落地")
print("- 智能问答能力 (Q-Agent)：大模型加RAG技术")
print("- 智能查询能力 (S-Agent)：实体抽取API集成")
print("- 智能办理能力 (H-Agent)：多轮对话智能填单")
print("- 智能诊断能力 (D-Agent)：规则引擎云哨对接")
